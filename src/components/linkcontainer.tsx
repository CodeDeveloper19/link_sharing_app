    ...
    return (
        <div className='w-full rounded-[12px] p-[20px] gap-[12px] bg-[#FAFAFA] flex flex-col'>
            ...
            <div className='flex flex-col w-full gap-[4px]'>
                ...
                <div className="flex flex-row items-center py-[12px] px-[16px] gap-[12px] rounded-[8px] border-[1px] border-[#D9D9D9] hover:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] hover:border-[#633CFF]">
