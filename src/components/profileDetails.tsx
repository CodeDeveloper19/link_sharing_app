  ...
  return (
        <div className='p-[40px] flex flex-col gap-[40px]'>
            ...
            <div className='flex flex-col gap-[24px] w-full'>
                ...
                <div className='rounded-[12px] flex flex-col p-[20px] gap-[12px] bg-[#FAFAFA] w-full'>
                    <div className='flex flex-row gap-[16px] w-full justify-between items-center'>
                        <p className='text-left font-[400] text-[16px] leading-[24px] text-[#737373]'>First name*</p>
                        <div className="flex flex-row w-full max-w-[432px] h-[48px] items-center py-[12px] px-[16px] gap-[12px] rounded-[8px] border-[1px] border-[#D9D9D9] focus-within:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] focus-within:border-[#633CFF]">
                            <input
                    ...
                    <div className='flex flex-row gap-[16px] w-full justify-between items-center'>
                        <p className='text-left font-[400] text-[16px] leading-[24px] text-[#737373]'>Last name*</p>
                        <div className="flex flex-row w-full max-w-[432px] h-[48px] items-center py-[12px] px-[16px] gap-[12px] rounded-[8px] border-[1px] border-[#D9D9D9] focus-within:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] focus-within:border-[#633CFF]">
                            <input
                    ...
                    <div className='flex flex-row gap-[16px] w-full justify-between items-center'>
                        <p className='text-left font-[400] text-[16px] leading-[24px] text-[#737373]'>Email</p>
                        <div className="flex flex-row w-full max-w-[432px] h-[48px] items-center py-[12px] px-[16px] gap-[12px] rounded-[8px] border-[1px] border-[#D9D9D9] focus-within:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] focus-within:border-[#633CFF]">
                            <input
