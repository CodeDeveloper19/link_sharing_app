    ...
    return (
        <>
            ...
            <main className='w-full flex justify-center'>
                <div className="w-full max-w-[1349px] px-[24px] pb-[24px] flex flex-col minLaptop:flex-row gap-[24px]">
                    ...
                    <form className='flex-grow rounded-[12px] bg-white flex flex-col'>
                        {
                            currenPage === 'links' ?
                            <linksContext.Provider value={[allLinks, setAllLinks]}>
                                <Links />
                        ...
                        <div className='relative border-t-[1px] border-[#D9D9D9] px-[40px] flex items-center justify-end py-[24px] w-full'>
                            ...
                            <button onSubmit={saveToDatabase} style={{opacity: (allLinks.length > 0) ? '1' : '0.25'}} className='active:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] rounded-[8px] text-[white] text-[16px] leading-[24px] font-[600] hover:bg-[#BEADFF] bg-[#633CFF] w-full phone:w-[91px] h-[46px]'>
                                Save
                            </button>
                        </div>
                    </form>
