    ...
    <main className="w-full min-h-screen h-full flex flex-col justify-center items-center py-[20px]">
      ...
      <section className="mt-[51px] p-[40px] flex flex-col gap-[40px] bg-[#FFF] rounded-[12px]">
        ...
        <form className="flex flex-col gap-[24px] w-[396px]">
          ...
          <button className="hover:bg-[#BEADFF] active:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] px-[27px] py-[11px] rounded-[8px] flex justify-center items-center w-full bg-[#633CFF] text-[16px] font-[600] leading-[24px] text-[#FFF]">Create new account</button>
