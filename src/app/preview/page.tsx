...
export default function Preview() {
  return (
    <>
        <header className='w-full p-[24px] gap-[8px] z-10'>
            <div className='w-full py-[16px] pr-[16px] pl-[24px] gap-[8px] rounded-[12px] bg-white'>
                <div className='w-full flex flex-row justify-between'>
                    ...
                    <button className='active:shadow-[0_0_32px_0_rgba(99,60,255,0.25)] rounded-[8px] text-[white] text-[16px] leading-[24px] font-[600] hover:bg-[#BEADFF] bg-[#633CFF] w-[133px] h-[46px]'>
                        Share Link
                    </button>
                </div>
            </div>
        </header>
        <div className='w-full absolute top-0 z-0 bg-[#633CFF] rounded-b-[32px] h-[357px]'></div>
        <main className='w-full flex justify-center z-10 mb-[200px]'>
            <div className='max-w-[349px] relative top-[90px] rounded-[24px] gap-[8px] py-[48px] px-[56px] bg-white shadow-[0_0_32px_0_#0000001A]'>
